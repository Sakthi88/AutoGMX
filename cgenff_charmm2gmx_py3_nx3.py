	...
	def write_pdb(self,f):
		for atomi in range(0,self.natoms):
			...
			f.write("%-6s%5d %-4s %-4s%5s%12.3f%8.3f%8.3f%6.2f%6.2f\n" %
				("ATOM",atomi+1,self.G.nodes[atomi]['name'],resn,self.G.nodes[atomi]['resid'],self.coord[atomi][0],
...
nx_ver = Version(nx.__version__)
if nx_ver < Version("2.0"):
    print("Your NetworkX version is:", nx.__version__)
    print("This script requires NetworkX 2.x or newer.")
    exit()
elif nx_ver > Version("3.6.1"):
    print("Warning: This script was patched for NetworkX 3.6.1.")
    print("Detected:", nx.__version__)
