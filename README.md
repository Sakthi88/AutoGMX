...
- **Multiple ligand parametrization options**: ACPYPE (GAFF/AMBER), CGenFF (CHARMM), CGenFF Server `.str` + `.mol2` conversion, pyPolyBuilder (dendrimers/polymers)
...
| `LIGAND_PREP_TOOL` | `acpype` | Ligand parametrization: `acpype`, `cgenff`, `cgenff_server`, `pypolybuilder` |
