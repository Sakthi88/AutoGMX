...
cp "${EM_WORK_DIR}/ligand.itp" "${EQUIL_WORK_DIR}/ligand.itp"
cp "${EM_WORK_DIR}/posre.itp" "${EQUIL_WORK_DIR}/posre.itp"
cp "${EM_WORK_DIR}/posre_ligand.itp" "${EQUIL_WORK_DIR}/posre_ligand.itp"
